...
namespace EVBSS.Api.Migrations
{
    ...
    [Migration("20251104033710_MakeUserSubscriptionVehicleNullable")]
    partial class MakeUserSubscriptionVehicleNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EVBSS.Api.Models.BatteryComplaint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("SwapTransactionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EVBSS.Api.Models.BatteryStockRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("RelatedBulkCreateRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RelatedBulkCreateRequestId");
                    ...
                    b.ToTable("BatteryStockRequests");
                });
            ...
            modelBuilder.Entity("EVBSS.Api.Models.BatteryComplaint", b =>
                {
                    ...
                    b.HasOne("EVBSS.Api.Models.User", "ReportedByUser")
                        .WithMany()
                        .HasForeignKey("ReportedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EVBSS.Api.Models.SwapTransaction", "SwapTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("EVBSS.Api.Models.BatteryStockRequest", b =>
                {
                    b.HasOne("EVBSS.Api.Models.User", "AdminReviewer")
                        .WithMany()
                    ...
                    b.HasOne("EVBSS.Api.Models.BulkCreateRequest", "RelatedBulkCreateRequest")
                        .WithMany()
                        .HasForeignKey("RelatedBulkCreateRequestId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EVBSS.Api.Models.User", "RequestedByStaff")
                        .WithMany()
                    ...
                    b.Navigation("RelatedBulkCreateRequest");
