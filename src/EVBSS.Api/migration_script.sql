...
CREATE TABLE [UserSubscriptions] (
    ...
    [CurrentMonthSwapCount] int NOT NULL,
...
CREATE TABLE [Payments] (
    ...
    CONSTRAINT [FK_Payments_UserSubscriptions_UserSubscriptionId] FOREIGN KEY ([UserSubscriptionId]) REFERENCES [UserSubscriptions] ([Id]) ON DELETE SET NULL,
